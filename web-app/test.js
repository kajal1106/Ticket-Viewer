  ...
  it("return page with previousButton nextButton and list of tickets", function (done) {
    ...
    server
      ...
      .end(function (err, res) {
        (res.text.includes('Ticket Id:'))
          .should
          .be
          .equal(true);
        (res.text.includes('btnPrevious'))
          .should
          .be
          .equal(true);
        (res.text.includes('btnNext'))
          .should
          .be
          .equal(true);
        done();
...
describe("When user clicks next button from current page", function () {
  ...
  it("return page with previousButton nextButton and list of tickets for next paginati" +
      "on section",
  function (done) {
...
describe("When user clicks previous button from current page", function () {
  ...
  it("return page with previousButton nextButton and list of tickets for previous pagi" +
      "nation section",
  function (done) {
...
describe("When user clicks detail view button to view single ticket details for ticket id " +
    "5",
function () {
    ...
    server
      ...
      .end(function (err, res) {
        (res.text.includes('Ticket Id:'))
          ...
          .be
          .equal(true);
        (res.text.includes('Subject'))
          .should
          .be
          .equal(true);
        (res.text.includes('Description'))
          .should
          .be
          .equal(true);
...
describe("Test Cases: Ticket List View - Direct URL Access", function () {
  ...
  it("GET /8989  get 8989th page which does not exists should respond 404 Not Found", function (done) {
    ...
    server
      ...
      .end(function (err, res) {
        (res.text.includes('Page Not Found'))
          .should
          .be
          .equal(true);
        done();
  ...
  it("GET /ramdom-text  Write invalid url should respond 404 Not Found", function (done) {
    ...
    server
      ...
      .expect(404) // THis is HTTP response
      .end(function (err, res) {
        (res.text.includes('invalid page requested or API not available'))
          .should
          .be
          .equal(true);
        done();
...
describe("Test Cases: Single Ticket View - Direct URL Access", function () {
  ...
  it("GET /ticket/7000  request details of ticket id 7000 which does not exists respon" +
      "d 404 Not Found",
  function (done) {
    ...
    server
      ...
      .expect(404) // THis is HTTP response
      .end(function (err, res) {
        (res.text.includes('invalid ticket id requested'))
          .should
          .be
          .equal(true);
        done();
  ...
  it("GET /ticket  invalid path starting with /ticket no ticket id provided respond 40" +
      "4 Not Found",
  function (done) {
